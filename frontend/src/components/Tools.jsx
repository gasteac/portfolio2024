...
export const Tools = () => {
  return (
    <div className='flex flex-wrap  flex-col gap-6 m-12 justify-center items-center'>
      {/* TARJETA FRONTEND */}
      <div className="bg-gray-950 bg-opacity-50 group hover:bg-emerald-900 hover:bg-opacity-30 transition-all px-2 pb-4 min-w-52 h-full rounded-2xl flex flex-col">
